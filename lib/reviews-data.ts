 ...
 * match Firsthand's real review profile (5.0 ★, 144 reviews, mix of services).
 *
 * TODO before launch: replace with real reviews via the Google Places API
 * (Place Details → reviews[]) or paste 10-15 real Google review snippets here.
 * Marked for easy find/replace: search "TODO_REPLACE_REVIEW".
 */
...
export interface Review {
  ...
  area: string;
  rating: 5;
  date: string; // ISO month, displayed as "March 2024"
  service: string;
  excerpt: string;
}
